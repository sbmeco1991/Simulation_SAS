...
************************************************
/* Case 2.1, N = 20, Obs = 5, AR(1) Structure */
************************************************;
...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 2.1 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_2.1_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
***************************************************************************
***************************************************************************
/* Fitting a Linear model based on the simulation obtained from Case 2.1 */
***************************************************************************
***************************************************************************;
...
ods rtf file='~/EST142/data/Tab_2.1_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
************************************************************************
************************************************************************
/* Fitting a US model based on the simulation obtained from Case 2.1 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_2.1_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.1_USFit_Type1.rtf' bodytitle_aux style=Journal3;
