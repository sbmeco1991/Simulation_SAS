...
**********************************************
/* Case 1.3, N = 200, Obs = 5, CS Structure */
**********************************************;
...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 1.3 */
************************************************************************
************************************************************************;
...
title1 'Table 1.3';
title2 'Results of Fixed Effects from the Simulations obtained under Case 1.3';
title3 'Fitting the model with CS var-cov structure';

ods rtf file='~/EST142/data/Tab_1.3_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
***************************************************************************
***************************************************************************
/* Fitting a Linear model based on the simulation obtained from Case 1.3 */
***************************************************************************
***************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.3_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
************************************************************************
************************************************************************
/* Fitting a US model based on the simulation obtained from Case 1.3 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.3_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.3_USFit_Type1.rtf' bodytitle_aux style=Journal3;
