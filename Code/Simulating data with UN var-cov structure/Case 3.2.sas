...
**********************************************
/* Case 2.2, N = 20, Obs = 10, US Structure */
**********************************************;
...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 3.2 */
************************************************************************
************************************************************************;
...
title1 'Table 3.2';
title2 'Results of Fixed Effects from the Simulations obtained under Case 3.2';
title3 'Fitting the model with a CS var-cov structure';

ods rtf file='~/EST142/data/Tab_3.2_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
***************************************************************************
***************************************************************************
/* Fitting a Linear model based on the simulation obtained from Case 3.2 */
***************************************************************************
***************************************************************************;
...
ods rtf file='~/EST142/data/Tab_3.2_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
************************************************************************
************************************************************************
/* Fitting a US model based on the simulation obtained from Case 3.2 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_3.2_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_3.2_USFit_Type1.rtf' bodytitle_aux style=Journal3;
