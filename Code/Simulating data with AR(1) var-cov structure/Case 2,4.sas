...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 2.4 */
************************************************************************
************************************************************************;
...
title1 'Table 2.4';
title2 'Results of Fixed Effects from the Simulations obtained under Case 2.4';
title3 'Fitting the model with a CS var-cov structure';

ods rtf file='~/EST142/data/Tab_2.4_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
options nocenter nodate nonumber nolabel;
title1 'Table 2.4';
title2 'Results of Fixed Effects from the Simulations obtained under Case 1.4';
title3 'Fitting the model with an US var-cov structure';

ods rtf file='~/EST142/data/Tab_2.4_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_2.4_USFit_Type1.rtf' bodytitle_aux style=Journal3;
