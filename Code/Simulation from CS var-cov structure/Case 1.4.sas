...
***********************************************
/* Case 1.4, N = 200, Obs = 10, CS Structure */
***********************************************;
...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 1.4 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.4_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
***************************************************************************
***************************************************************************
/* Fitting a Linear model based on the simulation obtained from Case 1.4 */
***************************************************************************
***************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.4_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
************************************************************************
************************************************************************
/* Fitting a US model based on the simulation obtained from Case 1.4 */
************************************************************************
************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.4_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.4_USFit_Type1.rtf' bodytitle_aux style=Journal3;
