...
*********************************************
/* Case 1.1, N = 20, Obs = 5, CS Structure */
*********************************************;
...
************************************************************************
************************************************************************
/* Fitting a CS model based on the simulation obtained from Case 1.1 */
************************************************************************
************************************************************************;
...
title1 'Table 1.1';
title2 'Results of Fixed Effects from the Simulations obtained under Case 1.1';
title3 'Fitting the model with a CS var-cov structure';

ods rtf file='~/EST142/data/Tab_1.1_CSFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_CSFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_CSFit_Type1.rtf' bodytitle_aux style=Journal3;
...
***************************************************************************
***************************************************************************
/* Fitting a Linear model based on the simulation obtained from Case 1.1 */
***************************************************************************
***************************************************************************;
...
ods rtf file='~/EST142/data/Tab_1.1_UNCORRFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_UNCORRFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_UNCORRFit_Type1.rtf' bodytitle_aux style=Journal3;
...
************************************************************************
************************************************************************
/* Fitting a US model based on the simulation obtained from Case 1.1 */
************************************************************************
************************************************************************;
...
options nocenter nodate nonumber nolabel;
title1 'Figure 2: Overspecification of Correlation Structure';

ods rtf file='~/EST142/data/Fig2_OS.rtf' bodytitle_aux style=StatDoc;

title "Overspecified Correlation Structure";
...
ods rtf file='~/EST142/data/Tab_1.1_USFit_FE.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_USFit_Type2.rtf' bodytitle_aux style=Journal3;
...
ods rtf file='~/EST142/data/Tab_1.1_USFit_Type1.rtf' bodytitle_aux style=Journal3;
